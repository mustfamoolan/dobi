...
<div>
    ...
    <div class="print-header">
        <div class="d-flex justify-content-between align-items-center mb-3">
            ...
            <div class="text-end">
                <h2 class="mb-0">{{ __('Employee Statement') }}</h2>
                <p class="mb-0 small text-muted">{{ date('Y-m-d H:i') }}</p>
            </div>
        </div>
        <div class="row align-items-center">
            <div class="col-6">
                <strong>{{ __('Employee') }}:</strong> {{ $employee->name }}<br>
                <strong>{{ __('Position') }}:</strong> {{ $employee->position ?? '-' }}
            </div>
            <div class="col-6 text-end">
                <strong>{{ __('Period') }}:</strong> {{ $startDate }} - {{ $endDate }}<br>
