        ...
        <div class="hstack gap-0 gap-sm-1">
          ...
          <div class="dropdown features-dropdown">
            <button type="button" class="btn icon-btn btn-text-primary rounded-circle position-relative"
              ...
              <span
                class="position-absolute translate-middle badge rounded-pill p-1 min-w-20px badge text-bg-primary">5</span>
            </button>
              ...
              <div class="card mb-0">
                ...
                <div class="header-cart-scrollable card-body px-0 py-2" data-simplebar>
                  ...
                  <div class="dropdown-item d-flex align-items-center gap-3 py-2">
                    <img src="{{ asset('assets/images/product/product-3.jpg') }}" class="img-fluid rounded-3 avatar-lg"
                      loading="lazy" alt="SoundMaster Wireless Headphones">
                  ...
                  <!-- Cart Item 2 -->
                  <div class="dropdown-item d-flex align-items-center gap-3 py-2">
                    <img src="{{ asset('assets/images/product/product-4.jpg') }}" class="img-fluid rounded-3 avatar-lg"
                      loading="lazy" alt="Cocooil Body Oil">
                    <div class="flex-grow-1 text-truncate">
                  ...
                  <!-- Cart Item 3 -->
                  <div class="dropdown-item d-flex align-items-center gap-3 py-2">
                    <img src="{{ asset('assets/images/product/product-6.jpg') }}" class="img-fluid rounded-3 avatar-lg"
                      loading="lazy" alt="Luxury Sunglasses">
                    <div class="flex-grow-1 text-truncate">
                ...
                <div class="d-flex align-items-center h6 mb-0">
                  ...
                  <div class="dropdown">
                    <a href="#!" class="btn btn-text-primary rounded-pill icon-btn-sm"
                      id="remix-cion-notifications-dropdown-settings" data-bs-toggle="dropdown" aria-expanded="false">
                  ...
                  <div class="d-flex">
                    <div class="flex-shrink-0 me-3">
                      <div class="avatar-item avatar">
                        <img class="img-fluid avatar" src="{{ asset('assets/images/avatar/avatar-9.jpg') }}"
                          alt="avatar image">
                      </div>
                    </div>
                    <div class="flex-grow-1">
                ...
                <li class="list-group-item list-group-item-action border-start-0 border-end-0">
                  <div class="d-flex">
                    <div class="flex-shrink-0 me-3 position-relative">
                      <div class="avatar-item avatar">
                        <img class="img-fluid avatar" src="{{ asset('assets/images/avatar/avatar-6.jpg') }}"
                          alt="avatar image">
                      </div>
                      <span
          ...
          <div class="dropdown profile-dropdown features-dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-end header-language-scrollable"
              ...
              <div class="dropdown dropstart d-block">
                <a class="dropdown-item d-block w-100 text-start" href="#!" data-bs-toggle="dropdown"
                  aria-expanded="false">
                  Set status
                </a>
              ...
              <a class="dropdown-item" href="#!">
                <div class="d-flex align-items-center">
                  ...
                  <div class="flex-grow-1 ms-2">
                    <h6 class="mb-0 lh-1">SRBThemes <span
                        class="badge bg-primary-subtle text-primary rounded-pill text-uppercase ms-1 mb-0 py-1 fs-10">PRO</span>
                    </h6>
