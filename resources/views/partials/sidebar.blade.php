...
<aside class="app-sidebar">
    ...
    <div class="app-sidebar-logo px-6 justify-content-center align-items-center">
        <a href="{{ url('/') }}">
            <img height="35" class="app-sidebar-logo-default" alt="DOKKAN"
                src="{{ asset('assets/images/DOKKAN.png') }}">
            <img height="40" class="app-sidebar-logo-minimize" alt="DOKKAN"
...
<div class="offcanvas offcanvas-md offcanvas-start small-screen-sidebar" data-bs-scroll="true" tabindex="-1"
    ...
    <div class="offcanvas-header hstack border-bottom">
        ...
        <div class="app-sidebar-logo">
            <a href="{{ url('/') }}">
                <img height="35" class="app-sidebar-logo-default h-25px" alt="DOKKAN"
                    src="{{ asset('assets/images/DOKKAN.png') }}">
                <img height="40" class="app-sidebar-logo-minimize" alt="DOKKAN"
                    src="{{ asset('assets/images/Favicon.png') }}">
            </a>
